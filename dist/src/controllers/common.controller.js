...
var getTrending = function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, services_1.commonService.getTrending()];
            case 1:
                result = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.log(error_1);
                res.status(error_1.statusCode).send({ message: http_status_1.default[error_1.statusCode] });
                return [3 /*break*/, 3];
